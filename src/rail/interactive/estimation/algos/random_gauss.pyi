...
def random_gauss_estimator(**kwargs) -> Any:
    """
    Random CatEstimator
    ...
    rail.estimation.algos.random_gauss.RandomGaussEstimator.estimate
    ...
    column_name : str, optional
        name of a column that has the correct number of galaxies to find length of
        Default: mag_i_lsst
...
def random_gauss_informer(**kwargs) -> Any:
    ...
    This function was generated from the function
    rail.estimation.algos.random_gauss.RandomGaussInformer.inform
